...
router.post('/createAdmin',[
  ...
  // if there are errors return bad request and the errors
   ...
   if (!errors.isEmpty()) {
    ...
    // check the whether admin with this email exists already
...
//Create a User using POST "/api/Authentication/createStudent" .No login required
...
//Create a User using POST "/api/Authentication/createTeacher" .No login required
